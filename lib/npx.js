...
Npx.prototype.enqueue = function (animation) {
  this.queue.push( promisifyAnimation(animation,1000) );
};

Npx.prototype.newAnimation = function(framelength, numberOfFrames, intensity){
  return new Animation(framelength, numberOfFrames, intensity);
};
...
Npx.prototype.setPixel = function (index, color) {
  ...
  return promisifyAnimation(buffer,1000);
};
